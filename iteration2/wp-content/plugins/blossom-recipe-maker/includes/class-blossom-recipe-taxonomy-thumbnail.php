 ...
 */
  ...
  { 
    ...
    <div class="form-field term-group">
     <label for="taxonomy-thumbnail-id"><?php _e('Image', 'blossom-recipe-maker'); ?></label>
     ...
     <p>
       <input type="button" class="button button-secondary taxonomy_media_button" id="taxonomy_media_button" name="taxonomy_media_button" value="<?php _e( 'Add Image', 'blossom-recipe-maker' ); ?>" />
       <input type="button" class="button button-secondary taxonomy_media_remove" id="taxonomy_media_remove" name="taxonomy_media_remove" value="<?php _e( 'Remove Image', 'blossom-recipe-maker' ); ?>" style="display:none;">
     </p>
    </div>
    <?php
 } 
 ...
 */
 ...
 {
 	if( isset( $_POST['taxonomy-thumbnail-id'] ) && '' !== $_POST['taxonomy-thumbnail-id'] ){
      $image = $_POST['taxonomy-thumbnail-id'];
 ...
 */
 public function update_recipe_taxonomy_image ( $term, $taxonomy ) { ?>
   <tr class="form-field term-group-wrap">
     ...
     <td>
       <?php $image_id = get_term_meta ( $term -> term_id, 'taxonomy-thumbnail-id', true ); 
       ?>
       <input type="hidden" id="taxonomy-thumbnail-id" name="taxonomy-thumbnail-id" class="taxonomy_media_id" value="<?php echo $image_id; ?>">
       ...
       <?php if ( $image_id ) {
       	?>
	       <p>
	       <input type="button" class="button button-secondary taxonomy_media_button" id="taxonomy_media_button" name="taxonomy_media_button" value="<?php _e( 'Change Image', 'blossom-recipe-maker' ); ?>" />
	       <input type="button" class="button button-secondary taxonomy_media_remove" id="taxonomy_media_remove" name="taxonomy_media_remove" value="<?php _e( 'Remove Image', 'blossom-recipe-maker' ); ?>">
	     </p>
	     <?php } 
	     else{
	     	?>
