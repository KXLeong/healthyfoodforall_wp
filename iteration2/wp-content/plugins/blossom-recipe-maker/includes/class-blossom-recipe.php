...
class Blossom_Recipe_Maker {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-blossom-recipe-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-blossom-recipe-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-blossom-recipe-admin.php';
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-blossom-recipe-functions.php';
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-blossom-recipe-print-functions.php';

		/**
		 * The class responsible for defining all hooks that display meta data in the archive section of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-blossom-recipe-archive-hook-functions.php';

		/**
		 * The class responsible for displaying recipe shortcode in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/frontend/recipe-shortcode.php';

		/**
		 * The class responsible for displaying recipe search bar in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-blossom-recipe-search-template.php';

		/**
		 * The class responsible for displaying recipe search results in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/templates/recipe-search-results.php';

		/**
		 * The class responsible for displaying recipe search shortcode in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/frontend/recipe-search-shortcode.php';

		/**
		 * The class responsible for displaying recipe taxonomy thumbnails in the admin
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-blossom-recipe-taxonomy-thumbnail.php';

		/**
		 * The class responsible for displaying recipe rich data in the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-blossom-recipe-seo.php';

		/**
		 * Popular Recipe Widget.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . '/includes/widgets/widget-popular-recipe.php';

		/**
		 * Recent Recipe Widget.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . '/includes/widgets/widget-recent-recipe.php';

		/**
		 * Recipe Categories Widget.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . '/includes/widgets/widget-recipe-categories.php';

		/**
		 * Recipes Category Slider Widget.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . '/includes/widgets/widget-recipes-category-slider.php';

		/**
		 * The class responsible for displaying recent recipes shortcode in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/frontend/recent-recipe-shortcode.php';

		/**
		 * The class responsible for recipe permalinks of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-blossom-recipe-permalinks.php';
