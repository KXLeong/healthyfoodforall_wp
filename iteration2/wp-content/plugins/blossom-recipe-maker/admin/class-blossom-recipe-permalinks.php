...
class Blossom_Recipe_Maker_Permalink_Settings {
	...
	public function settings_save() {
		...
		if ( isset( $_POST['permalink_structure'] ) ) {
			...
			$permalinks['blossom_recipe_base']             =  trim( $_POST['blossom_recipe_base'] );
			$permalinks['blossom_recipe_category_base']    =  trim( $_POST['blossom_recipe_category_base'] );
			$permalinks['blossom_recipe_cuisine_base']     =  trim( $_POST['blossom_recipe_cuisine_base'] );
			$permalinks['blossom_recipe_cooking_method_base']     =  trim( $_POST['blossom_recipe_cooking_method_base'] );
			$permalinks['blossom_recipe_tags_base']        =  trim( $_POST['blossom_recipe_tags_base'] );
