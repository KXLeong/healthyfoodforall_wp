jQuery(document).ready(function($) {
	...
	$(document).on('mouseenter', '.brm-comment-form-rating .brm-rating-star', function() {
	...
	$(document).on('mouseleave', '.brm-comment-form-rating .brm-rating-star', function() {
		$(this).siblings().andSelf().each(function() {
			$(this).find('polygon').css('fill', '');
		});
	});

	$(document).on('click', '.brm-comment-form-rating .brm-rating-star', function() {
		var star = $(this),
