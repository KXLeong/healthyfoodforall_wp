jQuery(function($){
  ...
  var frame;
    ...
    // ADD IMAGE LINK
  	$(document).on('click', 'a#recipe_add_image_button', function(event) 
  	{
  	...
  	// Change IMAGE LINK
  	$(document).on('click', 'a.recipe_change_image_button', function(event)
  	{
  	...
  	//DElete Image 
  	$(document).on('click', 'a.recipe_remove_image_button', function(event) 
  	{
  	...
  	function resetImagesIndex() 
  	{
	    ...
	    $('#recipe_feat_img_gallery_list li').each(function(i) {
