...
class Blossom_Recipe_Maker_Meta_Box {
	...
	public function brm_save_recipe_post( $post_id ) 
  {
	    ...
	    if (!isset($_POST['blossom_recipe_maker_nonce']) || !wp_verify_nonce($_POST['blossom_recipe_maker_nonce'], 'blossom_recipe_maker_save'))
         return;
      ...
      if (defined('DOING_AUTOSAVE') && DOING_AUTOSAVE) 
	   ...
	   if ( ! empty( $_POST['br_recipe'] ) ) {
          ...
          if(isset($_POST['br_recipe_gallery'])) 
          {
              update_post_meta($post_id, 'br_recipe_gallery', $_POST['br_recipe_gallery']);
          } 
          else 
          {
