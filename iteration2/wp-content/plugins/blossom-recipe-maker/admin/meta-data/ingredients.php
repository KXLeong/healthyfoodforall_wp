...
<div id="blossom-recipe-tab-recipe-ingredients" class="inside hidden">
    ...
    <div id="br-recipe-ingredients">
        <h1><?php _e('Ingredients', 'blossom-recipe-maker');?></h1>
        ...
        <div>
            ...
            <label for="br_recipe_servings">
                <h4><?php _e( 'Servings', 'blossom-recipe-maker' ); ?></h4>
            </label>
        ...
        <table id="br_recipe_ingredients">
            ...
            <thead>
                <tr>
                    <td>&nbsp;</td>
                    <th><?php _e('QUANTITY','blossom-recipe-maker' );?></th>
                    <th><?php _e('UNIT','blossom-recipe-maker' );?></th>
                    <th><?php _e('INGREDIENT','blossom-recipe-maker' );?><em style="color: red"> <?php _e('*','blossom-recipe-maker' );?></em></th>
                    <th><?php _e('NOTES','blossom-recipe-maker' );?></th>
                </tr>
                ...
                if(isset($ingredients['ingredient']) && !empty($filteredingredients)) 
                {
                    foreach( $ingredients['ingredient'] as $ingredient ) {
                        ...
                        <tr class="br_ingredients_heading">
                            ...
                            <td colspan="4">
                                <input name="br_recipe[ingredient][<?php echo $count; ?>][heading]" id="br_recipe_ingredient_heading_<?php echo $count; ?>" class="br_recipe_ingredient_heading" type="text" value="<?php echo isset ($ingredient['heading'] ) ? esc_attr( $ingredient['heading'] ) : '' ; ?>">
                            </td>
                            <td>
                        ...
                        <tr class="br_ingredients">
                            ...
                            <td>
                                ...
                                <select name="br_recipe[ingredient][<?php echo $count; ?>][unit]" class="br_ingredients_unit" id="br_ingredients_unit_<?php echo $count; ?>">

                                    <option value="">--</option>
                                    <?php foreach($measurements as $key => $measurement):
                                        echo '<option value="' . $key . '"' . ( $ingredient['unit'] == $key ? ' selected' : '' ) . '>' . esc_attr($measurement['plural_abbr']) . '</option>';
                                    endforeach; ?>
                                </select>
                            ...
                            <td>
                                ...
                                <input name="br_recipe[ingredient][<?php echo $count; ?>][ingredient]" class="br_ingredients_name" id="br_ingredients_name_<?php echo $count; ?>" placeholder="oil" type="text" value="<?php echo isset($ingredient['ingredient']) ? esc_attr( $ingredient['ingredient'] ) : '' ; ?>" required>
        ...
        <div id="br-add-ingredients-block"> 
            ...
            <a class="button button-primary button-large" href="javascript:void(0);" id="br-add-ingredients"><?php _e('Add an Ingredient','blossom-recipe-maker' );?></a>

            <a class="button button-primary button-large" href="javascript:void(0);" id="br-add-ingredients-heading"><?php _e('Add Section Heading','blossom-recipe-maker' );?></a>
