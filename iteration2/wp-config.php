...
define('WP_PLUGIN_URL', 'https://healthyfoodforall.tk/iteration2/wp-content/plugins'); 
define('WP_LANG_DIR', __DIR__ . "/wp-content/languages"); 
define('WP_HOME', 'https://healthyfoodforall.tk/iteration2'); 
define('WP_SITEURL', 'https://healthyfoodforall.tk/iteration2'); 
