jQuery(document).ready(function($) {
        ...
        $('#br-add-instructions-heading').on('click', function(e){
            e.preventDefault();
            addInstructionHeading();
        });

        $('.br-btn-wrap').click(function(e) {
        ...
        $(document).on('click', '.br_instructions_heading_delete', function(event) 
        {
            ...
            {
                $(this).parents('tr').animate({ opacity: 0 }, 200, function() {
                $(this).remove();
