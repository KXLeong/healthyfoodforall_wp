...
<div id="blossom-recipe-tab-recipe-instructions" class="inside hidden">
    ...
    <div id="br-recipe-instructions">
        <h1><?php _e('Instructions', 'blossom-recipe-maker');?></h1>
    	...
    	<table id="br_recipe_instructions">
    		...
    		<thead>
    			<tr>
                    <td>&nbsp;</td>
                    <th><?php _e('IMAGE','blossom-recipe-maker' );?></th>
    				<th><?php _e('INSTRUCTION','blossom-recipe-maker' );?></th>   				
    			</tr>
    		...
    		<tbody>
                ...
                if(isset($instructions['instructions']) && (!empty($filtereddescription)|| !empty($filteredimage)))
                {
                    foreach( $instructions['instructions'] as $instruction ) {
                        ...
                        ?>
                            <tr class="br_instructions_heading">
                                ...
                                <td colspan="4">
                                    <input name="br_recipe[instructions][<?php echo $count; ?>][heading]" id="br_recipe_instructions_heading_<?php echo $count; ?>" class="br_recipe_instructions_heading" type="text" placeholder="Section Heading" value="<?php echo isset ($instruction['heading'] ) ? esc_attr( $instruction['heading'] ) : '' ; ?>">
                                </td>
                                <td>
                        ...
                        ?>
        			     ...
        			     <tr class="br_instructions">
        	    			...
        	    			<td class="add-instruction-image <?php echo $class;?>">

                                <input name="br_recipe[instructions][<?php echo $count; ?>][image]" class="br_instructions_image" type="hidden" value="<?php echo isset($instruction['image']) ? esc_attr($instruction['image']) : ''; ?>" />

                                <div class="br-btn-wrap">
                                    <input id="br-add-image" class="br_instructions_add_image" type="button" value="<?php echo !empty($image) ? __('Change Image', 'blossom-recipe-maker') : __( 'Add Image', 'blossom-recipe-maker' ) ?>" />
                                    <label for="br-add-image">
                                        <div class="br-recipe-instruction-image-meta">
                                            <img src="<?php echo !empty($image) ? $image : '';?>" class="br_instructions_thumbnail"/>
                                        </div>
                                    </label>
                                </div>
                                <?php
                            ...
                            <td>
                                ...
                                <textarea name="br_recipe[instructions][<?php echo $count; ?>][description]" rows="6" cols="60" id="br_instructions_description_<?php echo $count; ?>" class="br_instructions_description"><?php echo isset ($instruction['description']) ? esc_textarea( $instruction['description'] ) : ''; ?></textarea>
                    ...
                    <td class="add-instruction-image">
                            ...
                            <div class="br-btn-wrap">
                                <input id="br-add-image" class="br_instructions_add_image" type="button" value="<?php _e( 'Add Image', 'blossom-recipe-maker' ) ?>" />
                    ...
                    <td>
                        ...
                        <textarea name="br_recipe[instructions][<?php echo $count; ?>][description]" rows="6" cols="60" id="br_instructions_description_<?php echo $count; ?>" class="br_instructions_description"></textarea>
    	...
    	<div id="br-add-instructions-block"> 
    		...
    		<a class="button button-primary button-large" href="javascript:void(0);" id="br-add-instructions"><?php _e('Add an Instruction','blossom-recipe-maker' );?></a>

            <a class="button button-primary button-large" href="javascript:void(0);" id="br-add-instructions-heading"><?php _e('Add Section Heading','blossom-recipe-maker' );?></a>
