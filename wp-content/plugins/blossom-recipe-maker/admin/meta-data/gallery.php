...
<div id="blossom-recipe-tab-recipe-gallery" class="inside hidden">
    ...
    <div id="br-recipe-gallery">
        <h1><?php _e('Gallery', 'blossom-recipe-maker');?></h1>
        ...
        <div class="br-recipe-meta-enable has_checkbox">
            <h4><?php _e('Enable Gallery','blossom-recipe-maker'); ?></h4>
        ...
        <div class="br-recipe-meta-video">
            ...
            <h4><?php _e('YouTube or Vimeo Video:', 'blossom-recipe-maker');?></h4>
        ...
        <div class="br-recipe-meta-gallery-btn">
            ...
            <h4><?php _e( 'Gallery Items', 'blossom-recipe-maker' ); ?></h4>

            <div class="br-recipe-meta-gallery-items">

                <ul id='recipe_feat_img_gallery_list'>

                    <?php if ($gallery) : unset($gallery['enable'], $gallery['video_url']);
                        ...
                        foreach ($gallery as $key => $value) : 
                            ...
                            <li>
                                ...
                                <input type='hidden' name='br_recipe_gallery[<?php echo $key; ?>]' value='<?php echo $value; ?>'/>

                                <img class='recipe_image_preview' src='<?php echo $image; ?>'>

                                <div class="br-gallery-btn-wrap">
                                    <a class='recipe_change_image_button' href='javascript:void(0);' data-uploader-title='<?php _e('Change Image', 'blossom-recipe-maker');?>' data-uploader-button-text='<?php _e('Change image', 'blossom-recipe-maker');?>'>
            ...
            <a id='recipe_add_image_button' class="button button-primary button-large" href='javascript:void(0);' data-uploader-title='<?php _e('Add Image(s) to Recipe gallery', 'blossom-recipe-maker');?>' data-uploader-button-text='<?php _e('Add Image(s)', 'blossom-recipe-maker');?>'>
                <?php _e('Add Image(s)','blossom-recipe-maker');?>
            </a>
