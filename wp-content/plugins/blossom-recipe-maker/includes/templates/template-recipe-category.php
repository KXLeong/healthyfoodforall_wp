		    ...
		    if($termchildren) 
		    {
		        ...
		        <?php
		        	foreach($termchildren as $child)
		        	{
		                ...
		                ?>
		                <div class="recipe-category-<?php echo $term->name;?>"> 
		                	<div class="item">
			                    ...
			                    if(!empty($child_term_description)):
				                    ...
				                    <div class="desc-holder">
				                    	<?php echo $child_term_description;?>
				                    </div>
				                    <?php
				                endif;
				                ?>
					    ...
					    if($category_tax_posts->have_posts()) : 
							...
							while($category_tax_posts->have_posts()) : $category_tax_posts->the_post();
	                        ...
	                        {
	                            echo '<div class="load-cuisines"><a href="'. esc_url( $term_link ).'"><span>'.__('See More Recipes','blossom-recipe-maker').'</span></a></div>';
	                        }
                        	wp_reset_postdata();
