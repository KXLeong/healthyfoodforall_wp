...
class Brm_Recipes_Category_Slider extends WP_Widget {
	...
	public function form( $instance ) {
	    ...
	    <p>
			...
			{
				?>
				<label for="brm-categories-term-select-<?php echo esc_attr( absint( $ran ) );?>"><?php _e( 'Choose Taxonomy Term:', 'blossom-recipe-maker' ); ?></label> 
				...
				{
					?>
			        <select id="brm-categories-term-select-<?php echo esc_attr( absint( $ran ) );?>" name="<?php echo $this->get_field_name('category'); ?>" class="brm-categories-term-select-<?php echo esc_attr( absint( $ran ) );?> widefat" style="width:100%;">
