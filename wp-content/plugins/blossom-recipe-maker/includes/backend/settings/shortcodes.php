...
<div id="blossom-recipe-shortcode-settings-tab" class="inside hidden">
	...
	<div class="blossom-recipe-fields-settings">
		...
		<h3><?php _e('Recent Recipes Shortcode' , 'blossom-recipe-maker');?></h3>

		<div class="recipe-note">
			<p><?php _e('Use below shortcode to display Recent Recipes anywhere in your website.', 'blossom-recipe-maker');?></p>
		</div>
	...
	<div class="blossom-recipe-fields-settings">
		...
		<h3><?php _e('Popular Recipes Shortcode' , 'blossom-recipe-maker');?></h3>

		<div class="recipe-note">
			<p><?php _e('Use below shortcode to display Popular Recipes anywhere in your website.', 'blossom-recipe-maker');?></p>
		</div>

		<h4><?php _e('Popular Recipes by Views' , 'blossom-recipe-maker');?></h4>
		...
		<h4><?php _e('Popular Recipes by Comments' , 'blossom-recipe-maker');?></h4>
	...
	<div class="recipe-note">
		<p><?php _e('replace the title and num_posts values as per your need.', 'blossom-recipe-maker');?></p>
	</div>
