...
use WPStaging\Vendor\Google\Service\PeopleService\CopyOtherContactToMyContactsGroupRequest;
use WPStaging\Vendor\Google\Service\PeopleService\ListOtherContactsResponse;
 ...
 *  </code>
 */
class OtherContacts extends \WPStaging\Vendor\Google\Service\Resource
{
    /**
     ...
     * @return Person
     */
    public function copyOtherContactToMyContactsGroup($resourceName, \WPStaging\Vendor\Google\Service\PeopleService\CopyOtherContactToMyContactsGroupRequest $postBody, $optParams = [])
    {
        $params = ['resourceName' => $resourceName, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('copyOtherContactToMyContactsGroup', [$params], \WPStaging\Vendor\Google\Service\PeopleService\Person::class);
    }
    /**
    ...
    public function listOtherContacts($optParams = [])
    {
        $params = [];
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \WPStaging\Vendor\Google\Service\PeopleService\ListOtherContactsResponse::class);
    }
    /**
    ...
    public function search($optParams = [])
    {
        $params = [];
        $params = \array_merge($params, $optParams);
        return $this->call('search', [$params], \WPStaging\Vendor\Google\Service\PeopleService\SearchResponse::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\Resource\OtherContacts::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_Resource_OtherContacts');
