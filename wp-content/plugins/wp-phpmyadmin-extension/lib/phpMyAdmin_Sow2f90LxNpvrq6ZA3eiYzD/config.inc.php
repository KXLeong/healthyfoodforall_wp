...
$cfg['blowfish_secret']					= '\\SZs%I`E}U})u2ulBw-0<Z{I(U8cR2Y1' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_Sow2f90LxNpvrq6ZA3eiYzD/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
